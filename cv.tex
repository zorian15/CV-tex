...
\address{Ph.D Candidate, Genome Sciences, Seattle,WA} % Address or description
...
\\ Ph.D in Genome Sciences (Expected Winter 2025/2026) \smallskip \\
...
\begin{rSection}{Programming Languages, Tools, and Concepts}
    ...
    \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} p{0.5\textwidth} @{} }
        Machine Learning & Deep learning frameworks (PyTorch), transformers, supervised/unsupervised methods, bayesian inference, anomaly detection \\
        Data Processing & Python, R, pandas, numpy, SQL, data pipelines, statistical analysis, reproducible research workflows \\
        Software Engineering & Test-driven development (TDD), software architecture \& refactoring, configuration management, type-safe systems design \\
        Cloud \& Deployment & Version control (Git), workflow management (Snakemake), CI/CD pipelines \\
        HPC & SLURM, CUDA, openMP, performance optimization \\
        Data Visualization & matplotlib, seaborn, ggplot2, interactive visualization techniques \\
        Development Environment & Unix, bash, collaborative version control, AI-assisted development, code review \& quality assurance \\
        Other Skills & Java, MATLAB, dimensionality reduction techniques (PCA, MDS, UMAP, t-SNE)
...
\begin{itemize}
    \item Developing end-to-end machine learning pipelines to predict viral fitness and evolution using large-scale biological data
    \item Designed and implemented biophysically-inspired neural networks (PyTorch) that enable accurate predictions of protein variant phenotypes from experimental data
    \item Applied statistical methods to analyze complex biological datasets and extract meaningful patterns
    \item Collaborated with research groups to validate models and improve computational approaches
\end{itemize}
...
\begin{itemize}
    \item Developed predictive environmental models integrating temperature-dependent biological parameters with disease transmission dynamics to forecast Bluetongue virus spread across different climate scenarios
...
\begin{itemize}
    ...
    \item \textbf{Thornton, Z.}, Haddox, H.K., Tran, T, Bedford, T, Matsen IV, F.A. (2025). Simulating the genetic and antigenic evolution of viruses under selection pressure from host immunity   \emph{Manuscript in preparation}
