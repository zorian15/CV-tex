...
\address{Seattle, WA} % Your secondary addess (optional)
...
\begin{itemize}
    ...
    \item El Moustaid, F., \textbf{Thornton, Z.}, Slamani, H., Ryan, S. and Johnson, LR (2019). \textit{Understanding the effect of temperature on Bluetongue disease risk in livestock}.
    \textit{Pending Review}
\end{itemize}
